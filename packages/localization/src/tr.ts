...
export const tr = {
  ...
  training: {
    home: {
      activeSessionTitle: 'Devam eden antrenman',
      freestyleLabel: 'Serbest antrenman',
      continueSession: 'Devam Et',
      startFreestyle: 'Serbest Antrenman Başlat',
      createProgram: 'Program Oluştur',
      myPrograms: 'Programlarım',
      myProgramsEmpty: 'Henüz bir program oluşturmadın',
    ...
    builder: {
      dayLabel: 'Gün',
      titleNew: 'Yeni Program',
      titleEdit: 'Programı Düzenle',
      namePlaceholder: 'Program adı',
      nameLabel: 'Program adı',
      dayNameLabel: 'Gün adı',
      removeDay: 'Günü sil',
      addDay: 'Gün ekle',
      ...
      searchExercisePlaceholder: 'Egzersiz ara',
      addExercise: 'Egzersiz ekle',
      save: 'Kaydet',
      error: 'Program kaydedilemedi. Tekrar dene.',
    },
    detail: {
    ...
    session: {
      summaryTitle: 'Antrenman Özeti',
      summaryDuration: 'Süre',
      summaryVolume: 'Toplam hacim',
      summaryCalories: 'Tahmini kalori',
      newRecords: 'Yeni Rekorlar',
      done: 'Bitti',
      freestyleTitle: 'Serbest Antrenman',
      abandon: 'Vazgeç',
      pickExercise: 'Egzersiz seç',
      changeExercise: 'Değiştir',
      setLabel: 'Set',
      bodyweightLabel: 'vücut ağırlığı',
      warmupLabel: 'Isınma seti',
      repsLabel: 'Tekrar',
      weightLabel: 'Ağırlık',
      completeSet: 'Seti Tamamla',
      finish: 'Antrenmanı Bitir',
      recordMaxWeight: 'en yüksek ağırlık',
      recordMaxReps: 'en yüksek tekrar',
      recordMaxVolume: 'en yüksek hacim',
      recordEstimated1RM: 'tahmini 1RM',
    },
    rest: {
      title: 'Dinlenme',
      skip: 'Atla',
