...
export const en: Translations = {
  ...
  camera: {
    ...
    catalogNotMatched: 'No catalog match — manual selection required',
    ...
    errors: {
      ...
      processing_error: "Couldn't complete the analysis. Try again.",
  ...
  training: {
    home: {
      activeSessionTitle: 'Workout in progress',
      freestyleLabel: 'Freestyle workout',
      continueSession: 'Continue',
      startFreestyle: 'Start Freestyle Workout',
      createProgram: 'Create Program',
      myPrograms: 'My Programs',
      myProgramsEmpty: "You haven't created a program yet",
      readyPrograms: 'Ready-Made Programs',
      dayLabel: 'days',
      weeksLabel: 'weeks',
    },
    builder: {
      dayLabel: 'Day',
      titleNew: 'New Program',
      ...
      save: 'Save',
      error: 'Could not save program. Try again.',
    },
    detail: {
    ...
    session: {
      ...
      recordMaxVolume: 'max volume',
      recordEstimated1RM: 'estimated 1RM',
    },
    rest: {
      title: 'Rest',
      skip: 'Skip',
